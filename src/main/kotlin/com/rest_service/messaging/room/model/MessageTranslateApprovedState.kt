...
class MessageTranslateApprovedState(private val domain: RoomDomain) : RoomState {
    ...
    override fun createResponseEvent(sagaEvent: SagaEvent) = SagaEvent(SagaEventType.MESSAGE_TRANSLATE_APPROVED, domain.operationId, ServiceEnum.ROOM_SERVICE, sagaEvent.responsibleUserId, domain.room).toMono()
