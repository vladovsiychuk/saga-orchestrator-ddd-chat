...
class RoomCreateApprovedState(private val domain: UserDomain) : UserState {
    override fun createResponseEvent(sagaEvent: SagaEvent) = SagaEvent(SagaEventType.ROOM_CREATE_APPROVED, domain.operationId, ServiceEnum.USER_SERVICE, sagaEvent.responsibleUserId, domain.currentUser).toMono()
